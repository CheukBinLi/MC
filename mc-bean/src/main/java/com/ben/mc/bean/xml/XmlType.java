...
public interface XmlType {
	...
	static final String XmlType_Bean = "Bean";
	static final String XmlType_CachePool = "CachePool";
	static final String XmlType_Intercept = "Intercept";
	...
	static final String XmlType_Values = "values";
